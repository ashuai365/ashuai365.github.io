...
function CloudWarehouseMapContent(){
  ...
  return <div className="cloudPrototype">
    ...
    <div className="cloudIntro"><div><small>全国云仓资源一张图</small><h2>找对仓，比找仓更重要。</h2><p>聚合真实仓源与运营能力，让每一次选址都有数据依据。</p></div><section><span><b>7,350</b>认证云仓</span><span><b>285</b>覆盖城市</span><span><b>15,577万㎡</b>可租面积</span></section></div>
