...
export default async function DemoPage({params}:{params:Promise<{slug:string}>}){
  ...
  return <div className="demoDetail">
    ...
    <main className={`demoStage ${slug==="bulk-trading-platform"||slug==="opportunity-publishing-workflow"||slug==="cloud-warehouse-map"||slug==="commodity-ai-ops"?"wideDemoStage":""}`} style={{"--demo-accent":demo.accent} as React.CSSProperties}>
